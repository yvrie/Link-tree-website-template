const config = {
    ...
    links: {
        ...
        anilist: 'https://anilist.co/user/yvrie/',
        discord: 'https://discord.com/users/1063170259764396103',
        steam: 'https://steamcommunity.com/id/Yvrie',
        github: 'https://github.com/yvrie',
    ...
    try {
        ...
        if (data.avatar_url) {
            ...
            if (data.name) {
                ...
                if (profileNameEl) {
                    profileNameEl.textContent = `@${config.profileName}`;
                }
            }
        }
    } catch (error) {
